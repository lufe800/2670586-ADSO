...
public class Facturador extends JFrame{
	...
	public void initComponent(){
		...
		*/
		...
		ActionListener evento_click_add = new ActionListener() {
			public void actionPerformed(ActionEvent event){
				imprimir();
			}
		};
		btn_add_producto.addActionListener(evento_click_add);
		...
		KeyListener evento_Key_cantProducto = new KeyListener(){
			public void keyPressed(KeyEvent e){
			}
		...
		input_cant_producto.addKeyListener(evento_Key_cantProducto);
	}
	...
	public void bucarProducto(){
		...
		String nombreProducto = input_nombre_producto.getText();
		for(int i=0; i<listaProductos.length; i++){
			if(listaProductos[i] !=null && listaProductos[i].getId().equals(id)){
				nombreProducto = listaProductos[i].getNombre();
	...
	public void imprimir(){
		...
		String nombreProducto = input_nombre_producto.getText();
		int cantidadProducto = Integer.parseInt(input_cant_producto.getText());
		int precioProducto = 0;

		for(int i= 0; i<listaProductos.length; i++){
			if(listaProductos[i] != null && listaProductos[i].getId().equals(idProducto)){
				precioProducto = listaProductos[i].getPrecio();
			}
		}

		int totalProducto = precioProducto * cantidadProducto;
		int totalFactura =+ totalProducto;
		String cadenaTotal = String.valueOf(totalFactura);

		String text = "=> "+nombreProducto + " x " + cantidadProducto +" = "+totalProducto;
