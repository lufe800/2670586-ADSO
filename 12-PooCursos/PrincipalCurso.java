    ...
    public static void main(String[] args){
        ...
        while(opcion < 7){
            ...
            if(opcion == 1){
                ...
                if(contaCursos < 99){
                    ...
                    if(codigoRepetido){
                        ...
                        cursos[contaCursos] = new Curso(Integer.toString(codigo), nombre, area, duracion);
                        contaCursos++;
            ...
            if(opcion == 2){
                ...
                for(int i = 0; i<cursos.length; i++){
                    if(cursos[i] != null){
                        System.out.println(cursos[i].getCodigo()+ "\t" + cursos[i].getNombre() + "\t" + cursos[i].getDuracion() + " hrs ");
                    }
                }
            }
            if(opcion == 3){
